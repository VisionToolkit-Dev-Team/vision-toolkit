...
![image](./docs/images/install-libs-twincat.png)

. Alternatively, if you are running 4024, you can open the root folder of the repo and double click `install-libraries.bat`.

3. Open the vision-toolkit-hmi in the solution tree
4. Open Desktop.view
5. Start live view

![image](./docs/images/start-live-view.png)
